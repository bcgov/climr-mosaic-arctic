...
# dir <- "C:/Users/CMAHONY/OneDrive - Government of BC/Data/Climatena_v742/PRISM_dem/Normal_1981_2010MP/"
# climatena <- rast(paste(dir, list.files(dir, pattern=paste(c("Tmin", "Tmax", "PPT")[e], monthcodes[m], ".asc", sep="")), sep=""))
